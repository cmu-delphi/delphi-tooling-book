...
```{r}
#| echo: false
with_messages_cat_to_stdout(print(five_days_ahead$epi_workflow))
```
...
```{r}
#| echo: false
with_messages_cat_to_stdout(print(extract_preprocessor(five_days_ahead$epi_workflow)))
```
...
```{r}
#| echo: false
with_messages_cat_to_stdout(print(extract_frosting(five_days_ahead$epi_workflow)))
```

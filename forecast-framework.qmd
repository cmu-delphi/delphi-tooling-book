...
what would happen if `jhu` contained the most recently available historical data and
...
to the most recently available data, and they lagged. But we could have instead used

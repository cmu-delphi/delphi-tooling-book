...
following methods. You will need a [GitHub Personal Access Token
(PAT)](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)
and store it in the environment variable `"GITHUB_PAT"`; a "classic" token with
at least `public_repo` access should work.
...
# If you don't have a GitHub PAT, either use the web interface and
# Sys.setenv/.Renviron, or use helpers like the following:
usethis::create_github_token() # opens a web browser to make a general-purpose PAT
gitcreds::gitcreds_set() # will ask the PAT; copy-paste from web browser

# Run this in a fresh session each time you'd like to use this set of versions:
invisible(gitcreds::gitcreds_get()) # checks that GitHub PAT can be found
renv::use(lockfile = "delphi-tooling-book.renv.lock")
# If you get 401 errors, you may need to regenerate your GitHub PAT.
```
